  ...
  return (
    <>
      ...
      <section className="h-screen w-screen bg-cover bg-center bg-no-repeat flex items-center justify-center relative overflow-hidden px-6 py-16">
        ...
        {/* Clouds Background */}
        <img src={GameBG} alt="GameBG" className="w-full h-full object-cover" />
        
        {/* Small decorative snail */}
        <div 
          className="absolute bottom-32 left-0 snail-animation"
        >
          <img src={Snail} alt="Snail" className="w-[100px] h-full object-center" />
        </div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-medium md:text-lg text-[#616161] font-['Inter']">
            <strong>Join Lina on her mission to learn how to care, share, and repair!</strong>
          </p>
        </div>
        ...
        <div className="flex justify-center relative">
          <img src={Lina} alt="Lina" className="w-[350px] h-full object-center" />
        </div>
      </div>
    </section>
    </>
