...
const Story3 = ({ onNext, onGoBack }) => {
  return (
    <section className="min-h-screen w-full bg-cover bg-center bg-no-repeat flex flex-col items-center justify-start relative overflow-hidden">
     

      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 flex flex-col items-center pb-8">
        {/* Story Header */}
        ...
        {/* Factory, Lina, and Cloud Scene with Responsive Layout */}
        <div className="w-full">
          {/* Mobile Layout - Vertical Stack (Factory → Lina → Cloud) */}
          <div className="flex flex-col items-center gap-3 sm:hidden">
            {/* Factory Image - First on mobile */}
            ...
            {/* Lina Character - Second on mobile */}
            <div className="w-full flex justify-center">
              <img src={Lina} alt="Lina" className="w-48 h-auto" />
            </div>

            {/* Cloud Speech Bubble - Third on mobile */}
            <div className="w-full flex justify-center">
              <img src={Cloud} alt="Speech bubble" className="w-44 h-auto" />
            </div>
          </div>

          {/* Desktop Layout - Absolute positioning for larger screens */}
